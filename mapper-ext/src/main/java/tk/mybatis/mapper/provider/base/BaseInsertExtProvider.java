...
public class BaseInsertExtProvider extends BaseInsertProvider {
    ...
    /**
     * BaseInsertProvider.processKey的copy，因为它是private，不能直接引用
     * @param sql
     * @param entityClass
     * @param ms
     * @param columnList
    ...
    public String insert(MappedStatement ms, boolean isSkipid) {
        ...
        sql.append(SqlHelper.insertColumns(entityClass, isSkipid, false, false));
